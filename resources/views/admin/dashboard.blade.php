...
<body class="xp-vertical">
 ...
 <div class="col-md-5 col-lg-3 order-3 order-md-2">
    ...
    border: none;">
            ...
            <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">Dashboard </h4>  
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">SITTE</a></li>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="card bg-success m-b-30">
                                <div class="card-body">
                                    <div class="xp-widget-box">
                                        <div class="float-left">
                                            <h4 class="xp-counter text-white">{{ $services }}</h4>
                                            <p class="mb-0 text-white">Total Services</p>                        
                                        </div>
                                        <div class="float-right">
                                            <div class="xp-widget-icon xp-widget-icon-bg bg-white">
                                                <i class="mdi mdi-buffer font-30 text-success"></i>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="card bg-warning m-b-30">
                                <div class="card-body">
                                    <div class="xp-widget-box">
                                        <div class="float-left">
                                            <h4 class="xp-counter text-white">{{ $clients }}</h4>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="card bg-danger m-b-30">
                                <div class="card-body">
                                    <div class="xp-widget-box">
                                        <div class="float-left">
                                            <h4 class="xp-counter text-white">{{ $commands }}</h4>
                                            <p class="mb-0 text-white">Total Commandes</p>                        
                                        </div>
                                        <div class="float-right">
                                            <div class="xp-widget-icon xp-widget-icon-bg bg-white">
    ...
    <!-- Morris Chart JS -->
    <script src="{{url('assets/assets_backend/plugins/morris/morris.min.js')}}"></script>
    <script src="{{url('assets/assets_backend/plugins/raphael/raphael-min.js')}}"></script>

    <!-- To Do List JS -->
    <script src="{{url('assets/assets_backend/js/init/to-do-list-init.js')}}"></script>

    <!-- Dashboard JS -->
    <script src="{{url('assets/assets_backend/js/init/dashborad-2.js')}}"></script>
...
<!-- Mirrored from xpanthersolutions.com/html/booster/html/vertical/dashboard-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 May 2020 04:24:31 GMT -->
</html>