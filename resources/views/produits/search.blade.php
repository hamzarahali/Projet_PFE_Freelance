...
@if ($success != '')
<div class="mt-50 text-center alert alert-success" style="margin-left: 100px; margin-right: 100px">
    <h4> {{$success}} </h4>
</div>
@endif
...
@foreach ($produits as $produit)
    ...
    <div class="shop-box">
    <div class="shop-img">
    <a href="{{ route('produit.edit', $produit->id) }}"> @foreach ($produit->medias as $media)
