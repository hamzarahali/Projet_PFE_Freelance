...
<head>
    ...
    <!-- Fevicon -->
    <!-- <img rel="shortcut icon" src="{{url('assets/assets_backend/images/logoo.png')}}"> -->

    <link rel="shortcut icon" href="{{ url('assets/assets_backend/images/logoo.png') }}">

    <!-- Start CSS -->
    <!-- Morris Chart CSS --> 
    <link rel="stylesheet" href="{{url('assets/assets_backend/plugins/morris/morris.css')}}">
...
<body class="xp-vertical">
    ...
    border: none;">
            ...
            @if ($success  != "")
        <div class="alert alert-danger text-center" style="    margin: 1rem 9rem;">
                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-username" name="name" placeholder="Nom" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-username" name="lastname" placeholder="Prénom" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label" for="val-username">Entreprise <span class="text-danger">*</span></label>

                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-username" name="entreprise" placeholder="Entreprise">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label" for="val-currency">Téléphone  <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-currency" name="phone" placeholder="Téléphone" required>
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label class="col-lg-3 col-form-label" for="val-currency">Email <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="email" class="form-control" id="val-currency" name="email" placeholder="email" required>
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label class="col-lg-3 col-form-label" for="val-currency">Mot de passe <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="password" class="form-control" id="val-currency" name="mdp" placeholder="Mot de passe" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label" for="val-currency">Confirmer le mot de passe <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="password" class="form-control" id="val-currency" name="val-currency" placeholder="Mot de passe" required>
                                        </div>
                                    </div>
